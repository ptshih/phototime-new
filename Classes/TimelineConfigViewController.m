...
- (void)setupHeader {
    ...
    [self.leftButton setBackgroundImage:[UIImage stretchableImageNamed:@"NavButtonLeftWhite" withLeftCapWidth:9 topCapWidth:0] forState:UIControlStateNormal];
    ...
    [self.centerButton setBackgroundImage:[UIImage stretchableImageNamed:@"NavButtonCenterWhite" withLeftCapWidth:9 topCapWidth:0] forState:UIControlStateNormal];
    ...
    [self.rightButton setBackgroundImage:[UIImage stretchableImageNamed:@"NavButtonRightWhite" withLeftCapWidth:9 topCapWidth:0] forState:UIControlStateNormal];
